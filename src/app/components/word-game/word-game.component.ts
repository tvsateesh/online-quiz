...
export class WordGameComponent implements OnInit {
  ...
  sightWords = [
    ...
    { word: 'me', meaning: 'Pronoun referring to oneself' },
    { word: 'my', meaning: 'Belonging to me' },
    { word: 'or', meaning: 'Used to present alternatives' },
    { word: 'an', meaning: 'Article used before vowels' },
    { word: 'as', meaning: 'In the same way that' },
    { word: 'by', meaning: 'Indicating the agent or means' },
    { word: 'do', meaning: 'To perform an action' },
    { word: 'go', meaning: 'To move or travel' },
    { word: 'no', meaning: 'Negative response' },
    { word: 'up', meaning: 'Toward a higher place' },
    { word: 'so', meaning: 'Therefore or to such a degree' },
    { word: 'if', meaning: 'In the event that' },
    { word: 'of', meaning: 'Belonging to or relating to' },
    { word: 'all', meaning: 'The whole amount or every one' },
    { word: 'one', meaning: 'The number 1' },
    { word: 'out', meaning: 'Away from inside' },
    { word: 'can', meaning: 'Able to or allowed to' },
    { word: 'get', meaning: 'To obtain or receive' },
    { word: 'his', meaning: 'Belonging to him' },
    { word: 'has', meaning: 'Possess in present tense' },
    { word: 'her', meaning: 'Belonging to her' },
    { word: 'did', meaning: 'Past tense of do' },
    { word: 'its', meaning: 'Belonging to it' },
    { word: 'may', meaning: 'Expressing possibility' },
    { word: 'see', meaning: 'To perceive with eyes' },
    { word: 'now', meaning: 'At the present time' },
    { word: 'way', meaning: 'A path or method' },
  ];
